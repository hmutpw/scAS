...
write.table(up_rmaps_tab,file.path(outdir,"events_postive_set.txt"),sep="\t",quote=F,row.names=F,col.names=F)
#------negative set
...
write.table(down_rmaps_tab,file.path(outdir,"events_negative_set.txt"),sep="\t",quote=F,row.names=F,col.names=F)
#------postive set
...
write.table(back_rmaps_tab,file.path(outdir,"events_background_set.txt"),sep="\t",quote=F,row.names=F,col.names=F)
}
}
